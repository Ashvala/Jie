...
function parseOrcLineAndRender(str, context) {
    ...
    var dial_str_head = '<div class="knob_container"><input type="text" value="0" class="dial" data-fgcolor="#0CA7DB" data-bgcolor="#333" data-angleOffset="-125" data-angleArc="256" data-min="0" data-max="1000" data-thickness="0.15" data-width="100" data-height="100" data-font-family="Roboto Light" data-name='
